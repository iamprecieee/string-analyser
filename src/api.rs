...
use crate::{
    ...
    routes::strings::{create_string, delete_string, get_all_strings_wrapper, get_string, get_by_natural_language},
};
...
pub async fn build_app(state: AppState) -> Router {
    Router::new()
        ...
        .route("/strings/filter-by-natural-language", get(get_by_natural_language))
